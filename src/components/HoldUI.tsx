...
const getCellClasses = (cellType: string, isHoldUsed: boolean) => {
  ...
  switch (cellType) {
    ...
    case 'J': return `${baseClasses} bg-gradient-to-br from-tetris-j via-tetris-j to-blue-700 shadow-[inset_2px_2px_4px_rgba(255,255,255,0.3),inset_-2px_-2px_4px_rgba(0,0,0,0.3)] border border-blue-400/20 ${opacity}`;
